...
filename = 'C:\Users\oromeute\Documents\git\FMCW-RADAR\Testing\dades_vco.txt';
delimiter = ' ';
startRow = 2;
...
dadesvco = table;
dadesvco.V = cell2mat(raw(:, 1));
dadesvco.F = cell2mat(raw(:, 2));
...
%% import data as column vector
v=dadesvco{:,1}
f=dadesvco{:,2}
%% Plot the data
plot(v,f,'b--o')
xlabel('Voltage tunning (V)')
